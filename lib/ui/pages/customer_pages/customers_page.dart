...
import 'package:app_vendas_lite/ui/widgets/ink_well_custom.dart';
...
class CustomersPage extends StatefulWidget {
  final bool? returnCustomerSelectedPop;
  const CustomersPage({super.key, this.returnCustomerSelectedPop});
      ...
      child: ListViewCustom(
        ...
        child: (index) {
          return InkWellCustom(
            onTap: (){
              if(widget.returnCustomerSelectedPop ?? false){
                context.pop(_customers[index]);
              }
            },
            child: Container(
